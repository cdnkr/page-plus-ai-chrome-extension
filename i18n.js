...
const MESSAGES = {
    en: {
        ...
        tooltip_home_title: 'AI Assistant Hub',
        tooltip_home_description: 'Access all AI-powered features and modes for text analysis, image capture, and page interaction',
        tooltip_text_title: 'Text Selection Mode',
        tooltip_text_description: 'Highlight text on the page to analyze, summarize, or write about with AI',
        tooltip_drag_title: 'Area Selection Mode',
        tooltip_drag_description: 'Drag to select an area on the page for AI querying or color analysis',
        tooltip_page_title: 'Current Page Mode',
        tooltip_page_description: 'Query the current page with AI',
        tooltip_history_title: 'Conversation History',
        tooltip_history_description: 'View or continue your previous AI conversations',
        tooltip_settings_title: 'Configuration',
    ...
    es: {
        ...
        tooltip_home_title: 'Centro de Asistente IA',
        tooltip_home_description: 'Accede a todas las funciones impulsadas por IA para análisis de texto, captura de imágenes e interacción con páginas',
        tooltip_text_title: 'Modo de Selección de Texto',
        tooltip_text_description: 'Resalta texto en la página para analizar, resumir o escribir sobre él con IA',
        tooltip_drag_title: 'Modo de Selección de Área',
        tooltip_drag_description: 'Arrastra para seleccionar un área en la página para consultas de IA o análisis de colores',
        tooltip_page_title: 'Modo de Página Actual',
        tooltip_page_description: 'Consulta la página actual con IA',
        tooltip_history_title: 'Historial de Conversaciones',
        tooltip_history_description: 'Ver o continuar tus conversaciones previas con IA',
    ...
    ja: {
        ...
        tooltip_home_title: 'AIアシスタントハブ',
        tooltip_home_description: 'テキスト分析、画像キャプチャ、ページ操作のためのAI機能にアクセス',
        tooltip_text_title: 'テキスト選択モード',
        tooltip_text_description: 'ページ上のテキストをハイライトしてAIで分析、要約、執筆',
        tooltip_drag_title: 'エリア選択モード',
        tooltip_drag_description: 'ページ上のエリアをドラッグしてAIクエリや色分析',
        tooltip_page_title: '現在のページモード',
        tooltip_page_description: '現在のページをAIでクエリ',
        tooltip_history_title: '会話履歴',
        tooltip_history_description: '以前のAI会話を表示または続行',
